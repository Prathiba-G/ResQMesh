...
export interface CascadeRisk {
  ...
  propagationPath: string[]; // e.g. ["payment-service (High Latency)", "order-service (Queue Backlog)", "notification-service (Starvation)"]
